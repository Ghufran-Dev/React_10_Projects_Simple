                    ...
                    <div class="flex flex-col gap-10">
                        ...
                        <div className="flex justify-between items-center">
                            <div class="w-full max-w-sm">
                                ...
                                <input type="text" class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-xl border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="Your Name" />
                            </div>
                            <div class="w-full max-w-sm">
                                <label class="block mb-2 text-xl text-slate-600 font-semibold">
                                    Last Name
                        ...
                        <div class="w-full max-w-sm">
                            ...
                            <input type="email" class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-xl border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="name@gmail.com" />
                        </div>
                        <div class="w-full flex flex-col">
                            <label class="block mb-2 text-xl text-slate-600 font-semibold">
                                Message
                            </label>
                            <textarea name="" id="" rows={10}  placeholder="Your Message" className="border text-xl"></textarea>
                        </div>
                    </div>
